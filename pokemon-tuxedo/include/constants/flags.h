...
#define FLAG_DEV_NO_COLLISION    0x20 // Walk through walls when set
#define FLAG_DEV_NO_ENCOUNTER    0x21 // No wild encounters when set
#define FLAG_DEV_NO_TRAINER_SEE  0x22 // Trainers won't see you when set
...
/* Pokemon Tuxedo multi-region flags (allocated from unused flag range 0x4C7-0x4DB) */
