...
/* Pokemon Tuxedo multi-region save data (Requirement 16.1-16.5) */
...
struct SaveBlock1
{
    ...
    /* Pokemon Tuxedo multi-region state (added for consolidation, Req 16) */
    struct PokemonTuxedoSaveData pokemonTuxedo;
    // sizeof: 0x3???
};
