...
#define OW_FLAG_NO_ENCOUNTER        0x21  // If this flag is set, wild encounters will be disabled. (FLAG_DEV_NO_ENCOUNTER)
#define OW_FLAG_NO_TRAINER_SEE      0x22  // If this flag is set, trainers will not battle the player unless they're talked to. (FLAG_DEV_NO_TRAINER_SEE)
#define OW_FLAG_NO_COLLISION        0x20  // If this flag is set, the player will be able to walk over tiles with collision. (FLAG_DEV_NO_COLLISION)
